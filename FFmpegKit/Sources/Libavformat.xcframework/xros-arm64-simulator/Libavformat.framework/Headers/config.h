...
#define FFMPEG_CONFIGURATION "--prefix=/Users/sutherland/KSPlayerStack/FFmpegKit/.Script/FFmpeg/xrsimulator/thin/arm64 --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-linux-perf --disable-shared --disable-small --disable-symver --enable-cross-compile --enable-optimizations --enable-pic --enable-runtime-cpudetect --enable-static --enable-thumb --enable-version3 --pkg-config-flags=--static --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avcodec --enable-avdevice --enable-avfilter --enable-avformat --enable-avutil --enable-network --enable-swresample --enable-swscale --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-hwaccel='av1_vulkan,hevc_vulkan,h264_vulkan' --enable-bsfs --disable-debug --enable-stripping --enable-gpl --arch=aarch64 --target-os=darwin --enable-libxml2 --enable-neon --enable-asm --enable-videotoolbox --enable-audiotoolbox --enable-filter=yadif_videotoolbox --enable-filter=scale_vt --enable-filter=transpose_vt --disable-programs --disable-indev=avfoundation --enable-libshaderc --enable-vulkan --enable-vulkan-static --enable-lcms2 --enable-libdav1d --enable-decoder=libdav1d --enable-libplacebo --enable-filter=libplacebo --enable-libfreetype --enable-libharfbuzz --enable-libfribidi --enable-libass --enable-filter=ass --enable-filter=subtitles --enable-gmp --enable-gnutls --enable-libsmbclient --enable-protocol=libsmbclient --enable-libsrt --enable-protocol=libsrt --enable-libzvbi --enable-decoder=libzvbi_teletext --enable-libfontconfig --enable-libbluray"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/Users/sutherland/KSPlayerStack/FFmpegKit/.Script/FFmpeg/xrsimulator/thin/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/sutherland/KSPlayerStack/FFmpegKit/.Script/FFmpeg/xrsimulator/thin/arm64/share/ffmpeg"
