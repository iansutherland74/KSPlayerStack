...
#define __GMP_CC "/usr/bin/clang -std=gnu23"
#define __GMP_CFLAGS "-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/XRSimulator.platform/Developer/SDKs/XRSimulator26.2.sdk -target arm64-apple-xros26.0-simulator  -fno-common"
